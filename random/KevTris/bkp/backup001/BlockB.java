...
public class BlockB extends BlockAbstract {
    ...
    public BlockB() {
        ...
        blocks[0] = new BuildingBlock(0, 0);
        blocks[1] = new BuildingBlock(KevtrisConstants.GAP, 0);
        blocks[2] = new BuildingBlock(0, KevtrisConstants.GAP);
        blocks[3] = new BuildingBlock(0, KevtrisConstants.GAP * 2);
