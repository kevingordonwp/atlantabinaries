...
public abstract class BlockAbstract {
     ...
     * position
     *
     * [current position][x or y values][block index]
     *
     */
     ...
     *
     * @param Stack blockStack see above for details
     */
     ...
     * direction.
     *
     * @param int spaces - The number of spaces that it is to be moved
     * @param int movement - The direction to be moved
     */
                ...
                for(int i=0; i<tempBuildingBlocks.length; i++) {
                    ...
                    for(int j=0; j<blocks.length; j++) {
                        ...
                        if(tempBuildingBlocks[i].getXLocation() == proposedX[j] &&
                                tempBuildingBlocks[i].getYLocation() == proposedY[j]) {
                            canMoveDown = false;
                            break;
                        }
