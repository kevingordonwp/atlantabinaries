 ...
 *
 * This class defines the block A. Block A exttends the
...
public class BlockA extends BlockAbstract {
    ...
    public BlockA() {
        ...
        blocks[0] = new BuildingBlock(KevtrisConstants.GAP, 0);
        blocks[1] = new BuildingBlock(0, KevtrisConstants.GAP);
        blocks[2] = new BuildingBlock(0, KevtrisConstants.GAP * 2);
        blocks[3] = new BuildingBlock(KevtrisConstants.GAP, KevtrisConstants.GAP);
